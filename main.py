...
db_path = r'C:\Users\Siris\Desktop\D69 README FILE!!!!!!\r30-r39\r40_env_NWY\instance\posts.db'
...
if __name__ == "__main__":
    app.run(debug=True)
    # The following block should be run only once to set the admin user
    with app.app_context():
